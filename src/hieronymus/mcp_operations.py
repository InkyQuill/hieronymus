...
for _operation in (
    ...
    "concept_rename",
    "concept_facet_add",
    "concept_facet_update",
    "concept_facet_list",
    "concept_facet_set_canonical",
    "concept_semantic_tags_set",
    "crystal_link_concept",
    "crystal_story_scopes_set",
    "crystal_semantic_tags_set",
    "rule_crystals_list",
    "rule_crystal_archive",
    "rule_crystal_validate",
    "termbase_contract",
    "termbase_validate",
    "termbase_propose",
    "termbase_approve",

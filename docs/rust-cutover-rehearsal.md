...
| Actual Claude / Codex / zCode | **Open.** See [native host evidence](agent-host-acceptance.md). Installed stdio tool calls are not substitutes for those hosts' failed initialize handshake. |
